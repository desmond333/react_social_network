...
const dialogsPageReducer = (state = initialState, action) => {
    ...
    if (action.type === SEND_NEW_MESSAGE) { //реагируем на приходящие action
        return { //создаём и сразу возвращаем
            ...state,
            messagesData: [...state.messagesData, {id: 7, message: action.textMessage}/*вместо push*/] //добавляем новый подОбъект в state через onClick
